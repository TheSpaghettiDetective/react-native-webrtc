...
public class ExSurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    public ExSurfaceViewRenderer(Context context) {
        super(context);
    ...
    public ExSurfaceViewRenderer(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.eglRenderer = new SurfaceEglRenderer(this.resourceName);
        this.getHolder().addCallback(this);
        this.getHolder().addCallback(this.eglRenderer);
    ...
    public void onFrame(VideoFrame frame) {
        VideoFrame outVideoFrame = new VideoFrame(frame.getBuffer(), this.rotate90, frame.getTimestampNs());
        this.eglRenderer.onFrame(outVideoFrame);
    }
